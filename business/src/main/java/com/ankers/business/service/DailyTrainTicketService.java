...
import com.ankers.business.domain.DailyTrain;
import com.ankers.business.domain.TrainStation;
import com.ankers.business.enums.SeatTypeEnum;
import com.ankers.business.enums.TrainTypeEnum;
...
import com.ankers.business.domain.DailyTrainTicketExample;
import com.ankers.business.mapper.DailyTrainTicketMapper;
    ...
    public void genDaily(DailyTrain dailyTrain, Date date, String trainCode) {
        ...
        for (int i = 0; i < stationList.size(); i++) {
            ...
            for (int j = (i + 1); j < stationList.size(); j++) {
                ...
                dailyTrainTicket.setStartIndex(i);
                dailyTrainTicket.setEnd(trainStationEnd.getName());
                dailyTrainTicket.setEndPinyin(trainStationEnd.getNamePinyin());
                dailyTrainTicket.setEndTime(trainStationEnd.getInTime());
                dailyTrainTicket.setEndIndex(j);
