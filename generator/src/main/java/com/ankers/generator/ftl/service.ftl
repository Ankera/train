package com.ankers.${module}.service;
...
import com.ankers.${module}.domain.${Domain};
import com.ankers.${module}.domain.${Domain}Example;
import com.ankers.${module}.mapper.${Domain}Mapper;
